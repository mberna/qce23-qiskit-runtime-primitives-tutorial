...
Instructions can be found at the [Qiskit IBM Runtime](https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.12#account-setup) repository.
...
```sh
$ git clone https://github.com/mberna/qce23-qiskit-runtime-primitives-tutorial.git
$ cd qce23-qiskit-runtime-primitives-tutorial
```
...
Next, we assume that [Python](https://www.python.org/) 3.9 or higher is installed.  It is recommended to use a Python virtual environment that is dedicated to working with this repo.  The steps in the remainder of this document will assume that this environment is activated using either method.
...
```sh
$ conda create -n qiskit_runtime_env python=3.9
...
Note: In this tutorial we will be using the `experimental` branch of the `qiskit-ibm-runtime` library.

## 5. Verify your installation

Run the [`test_installation.py`](docs/test_installation.py) script to verify your installation:

```shell script
$ python3 ./docs/test_installation.py
```
